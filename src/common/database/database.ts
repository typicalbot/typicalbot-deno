...
const systemGuildBlacklist = db.collection<SystemGuildBlacklist>('system_guild_blacklist');
const systemUserBlacklist = db.collection<SystemUserBlacklist>('system_user_blacklist');